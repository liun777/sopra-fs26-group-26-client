...
| **liun777** | 05.04.2026   | [[Link to Commit 1]](https://github.com/liun777/sopra-fs26-group-26-server/commit/deb441ccdad8107fd983c12b3578c38305027557) | The endpoint and the corresponding logic in the service was already implemented so a LobbyDTO was added and the backend responses accordingly adjusted. | This helps to give uniform responses from the backend and controll which fields should be revealed to the frontend. |
